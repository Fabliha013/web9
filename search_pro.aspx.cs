...
using localhost;
using System.IO;
public partial class search_pro : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select * from [order] where description like('" + name.ToString() + "%')";
        cmd.ExecuteNonQuery();
        ...
        foreach (DataRow dr in dt.Rows)
        {
            ...
            Response.Write("<td style=\"width:400px; left:20px; right:20px;\">"); Response.Write("<font color=\"white\">"); Response.Write(dr["description"].ToString()); Response.Write("</font>"); Response.Write("</td>");
